...
export const GuideCard: React.FC<GuideCardProps> = ({
  ...
  return (
    <div
      className={`rounded-2xl transition-all duration-200 bg-white flex flex-col justify-between overflow-hidden shadow-xs hover:shadow-md ${
        isPreviewActive
          ? 'ring-2 ring-[#0076BD]'
          : isSelected
          ? 'ring-1 ring-[#0076BD]/50'
          : ''
      }`}
    >
      <div>
        ...
        <div className="p-4 sm:p-5">
          ...
          <div className="flex items-center justify-between gap-2 mb-3">
            ...
            <div className="flex items-center space-x-1.5">
              {guide.isCustom ? (
                ...
                <span className="text-[10px] font-bold bg-[#004372]/10 text-[#004372] px-2 py-0.5 rounded-full">
                  Official Guide
                </span>
              )}
              <span
          ...
          {/* Key Topics */}
          <div className="bg-[#E6E6E6]/30 rounded-xl p-3 mb-3">
      ...
      {/* Card Action Footer */}
      <div className="bg-[#E6E6E6]/25 p-3 flex items-center justify-between gap-2">
          ...
          {isAdmin && (
            <>
              ...
              <button
                ...
                className="inline-flex items-center p-1.5 rounded-lg text-xs font-medium bg-white text-slate-600 hover:text-slate-900 hover:bg-slate-100 shadow-2xs transition-colors"
              >
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold bg-[#0076BD]/10 hover:bg-[#0076BD]/20 text-[#0076BD] shadow-xs transition-colors"
        >
